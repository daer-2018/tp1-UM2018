...
import com.example.demologfj.modelo.IPublicacionDao;
import com.example.demologfj.servicio.IPublicacionServicio;
...
/*  @Override
  public int republicarPublicacionServicio (Publicador publicador, Publicacion publicacion) {
   ...
   //   return publiRepublicada.getIdPublicacion();
  //}
  @Override
